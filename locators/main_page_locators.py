...
class MainPageLocators:
    ...
    INGREDIENT_DETAILS_TEXT = By.XPATH, "//h2[contains(text(), 'Детали ингредиента')]"  # Текст с инфо о ингредиенте
    CLOSE_INGREDIENT_DETAILS_BUTTON = By.XPATH, "//button[contains(@class, '_close')]"  # Крестик закрытия окна
    BUN_R2_D3 = By.XPATH, "//p[contains(text(), 'Флюоресцентная булка R2-D3')]"  # Локатор булки
